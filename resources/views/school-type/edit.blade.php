    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <form method="post" action="/school_type/update/{{$school_type->id}}" class="mt-6 space-y-6">
                        @csrf
                    
                        <div class="col-md-6 mb-3 mt-3 ml-3">
                            <x-input-label for="school_type" :value="__('School Type')" />
                            <x-text-input id="school_type" name="school_type" type="text" class="mt-1 block w-full" :value="old('school_type', $school_type->school_type)" required />
